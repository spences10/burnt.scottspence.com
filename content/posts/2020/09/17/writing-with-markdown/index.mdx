...
<small>
  Right now the component I have for the Markdown rendering doesn't support it
  so I'll be adding these in with no rendered example.
</small>
...
[december 2004 on daring fireball]: https://daringfireball.net/projects/markdown/
