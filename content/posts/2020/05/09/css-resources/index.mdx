...
```js
[...document.querySelectorAll('.named-color-table [id^="valdef-color-"]')].map(
...
[medium post]: https://medium.com/@elad/new-css-logical-properties-bc6945311ce7
[css-tricks.com/glitch-effect-text-images-svg]: https://css-tricks.com/glitch-effect-text-images-svg/
...
[9elements.github.io/fancy-border-radius]: https://9elements.github.io/fancy-border-radius
...
[animated gradients codesandbox]: https://codesandbox.io/s/muddy-sun-gp0el
