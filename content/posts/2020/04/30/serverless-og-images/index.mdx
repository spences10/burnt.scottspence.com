...
const Image = () => {
  return (
    <img
      alt={params.title}
      style={{ width: "100%" }}
      src={`https://image-og.now.sh/og.jpg${objectToQueryParams(params)}`}
    />
  );
};
...
[og image function]: https://github.com/abnormalstudio/leighhalliday/blob/master/src/templates/article.tsx#L73
[generate og image]: https://github.com/spences10/generate-og-image
[into this site]: https://github.com/spences10/thelocalhost/blob/master/src/templates/post-template.js#L157
