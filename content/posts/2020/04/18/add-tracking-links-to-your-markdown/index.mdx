...
[custom domains]: https://usefathom.com/blog/bypass-adblockers?goalId="IBQBRDPP"
```
...
[track custom events]: https://scottspence.com/2020/01/02/track-custom-events-with-fathom-analytics/
