...
private: true
description:
  I have delivered this talk several times now but not actually
  written about it. Sooooo, let's tal...
---
...
Hugo uses Go, <Sarcasm>but where's the JavaScript!!?!1</Sarcasm> see
