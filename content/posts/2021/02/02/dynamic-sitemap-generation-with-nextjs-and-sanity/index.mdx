---
date: 2021-02-02
title: Sitemap Generation for Dynamic Routes In NextJS with the Sanity
  Client
...
[slack message asking about site map]: ./slack-message-asking-about-site-map.png
[knut slack reply]: ./knut-slack-reply.png
[james weis reply headers to text/xml]: ./james-weis-reply-headers-to-text-xml.png
[asking for permission to add this content to my blog]: ./credit-james.png
