...
[setting up a custom email with zoho]: https://scottspence.com/2020/04/25/custom-email-domain-with-now/
...
[setting up protonmail with vercel]: https://scottspence.com/2021/02/26/setting-up-proton-mail-with-vercel/
