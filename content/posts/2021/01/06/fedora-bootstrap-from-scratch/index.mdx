...
To do that, from the current shell I'm going to edit the
`/etc/wsl.conf` file and [add in my default user]:

```bash
sudo nano /etc/wsl.conf
# then add my user to the file
[user]
default=scott
```
...
[add in my default user]: https://github.com/Microsoft/WSL/issues/3974
