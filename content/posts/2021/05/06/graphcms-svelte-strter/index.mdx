...
of clicable links to take the user to the post.
...
familiar with this next part, if not then it's a way to determine the
routes (URL address) in the project programmatically.
